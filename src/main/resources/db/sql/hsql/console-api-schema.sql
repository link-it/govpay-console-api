...
CREATE SEQUENCE seq_rt_recuperi AS BIGINT START WITH 1 INCREMENT BY 1 ; -- (Scommentare in hsql 2.x) NO CYCLE;
...
(
	...
	-- fk/pk columns
	id BIGINT GENERATED BY DEFAULT AS SEQUENCE seq_rt_recuperi,
	-- fk/pk keys constraints
	CONSTRAINT pk_rt_recuperi PRIMARY KEY (id)
);

CREATE TABLE rt_recuperi_init_seq (id BIGINT);
INSERT INTO rt_recuperi_init_seq VALUES (NEXT VALUE FOR seq_rt_recuperi);
