...
/**
 * Parser di `?sort=` per `GET /pagopa/enti-creditori`. Formato `field[,field]*`
 * dove ogni `field` puo' essere prefissato da `-` (DESC) o `+` (ASC, default). I
 * nomi sono whitelist-ed: campi non riconosciuti causano
