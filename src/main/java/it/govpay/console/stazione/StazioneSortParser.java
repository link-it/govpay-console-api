...
/**
 * Parser di `?sort=` per `GET /intermediari/{id}/stazioni`. Formato `field[,field]*`,
 * ogni `field` prefissabile da `-` (DESC) o `+` (ASC, default). Nomi whitelist-ed:
 * campi non riconosciuti causano {@link IllegalArgumentException} (400 dal controller).
 */
